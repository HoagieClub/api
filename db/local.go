...
func SetupInitialDatabase(client *mongo.Client) error {
	...
	posts := []PostData{
		...
		{Id: "19", Title: "My watch", Category: "lost", Tags: []string{"lost"}, Description: "Was studying in Firestone and noticed I lost my watch, it has a blue strap and red watchface.", User: potato, Thumbnail: "https://i.imgur.com/bbZ5Tmj.png"},
		...
		{Id: "34", Title: "My watch", Category: "lost", Tags: []string{"lost"}, Description: "Was studying in Firestone and noticed I lost my watch, it has a blue strap and red watchface.", User: potato, Thumbnail: "https://i.imgur.com/bbZ5Tmj.png"},
